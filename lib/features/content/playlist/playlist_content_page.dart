...
import '../byOrder/content_by_order_page.dart';
import '../rating_controller/rating_controller.dart';
import '../single/single_content_page.dart';

class PlaylistContentPage extends StatefulWidget {
  PlaylistContentPage({Key? key}) : super(key: key);
...
class _PlaylistContentPageState extends State<PlaylistContentPage> {
  final controller = Get.put(PlaylistContentController());
